...
(define_insn "fixunsdfsi"
  [(set (match_operand:SI 0 "general_operand" "=dm")
	(plus:SI (fix:SI (match_operand:DF 1 "general_operand" "f")) (const_int 1)))]
  "TARGET_68881 || TARGET_FPA"
  "fmove%.l %1,%0")
...

;; Added nop instruction in front of fseq instruction -- Shawn Islam
(define_insn "seq"
  [(set (match_operand:QI 0 "general_operand" "=d")
	(eq (cc0) (const_int 0)))]
  ""
  ...
  cc_status = cc_prev_status;
#ifdef ti1500
  OUTPUT_JUMP (\"seq %0\", \"nop\\n\\tfseq %0\", \"seq %0\");
#else
  OUTPUT_JUMP (\"seq %0\", \"fseq %0\", \"seq %0\");
#endif
")

;; added nop in front of fsne instruction -- Shawn Islam
(define_insn "sne"
  [(set (match_operand:QI 0 "general_operand" "=d")
	(ne (cc0) (const_int 0)))]
  ""
  ...
  cc_status = cc_prev_status;
#ifdef ti1500
  OUTPUT_JUMP (\"sne %0\", \"nop\\n\\tfsne %0\", \"sne %0\");
#else
  OUTPUT_JUMP (\"sne %0\", \"fsne %0\", \"sne %0\");
#endif
")

;; added nop in front of fsgt instruction -- Shawn Islam
(define_insn "sgt"
  [(set (match_operand:QI 0 "general_operand" "=d")
	(gt (cc0) (const_int 0)))]
  ""
...
;; added nop in front of fslt instruction -- Shawn Islam
(define_insn "slt"
  [(set (match_operand:QI 0 "general_operand" "=d")
	(lt (cc0) (const_int 0)))]
  ""
...
;; added nop in front of fsge instruction -- Shawn Islam
(define_insn "sge"
  [(set (match_operand:QI 0 "general_operand" "=d")
	(ge (cc0) (const_int 0)))]
  ""
...
;; added nop in front of fsle instruction -- Shawn Islam
(define_insn "sle"
  [(set (match_operand:QI 0 "general_operand" "=d")
	(le (cc0) (const_int 0)))]
  ""
...
;; Modified for TI S1500 68010 support -- Shawn Islam
...
;; Modified for 68010 TI S1500 -- Shawn Islam
